...
import ShowProfessorsPresentational from '@/features/professor/components/ShowProfessorsPresentational/ShowProfessorsPresentational';

export default function ShowProfessorsContainer() {
  ...
  const [searchConditionsTitle, setSearchConditionsTitle] = useState('')
  ...
  } = useSyncProfessors(universitiesUuid, 10, currentPage, keyword, facultyId)
